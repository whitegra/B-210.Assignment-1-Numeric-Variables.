...
#to calculate and print the coin amounts:
...
temp_scale = input("Enter the scale you are starting with: ('c' for celcius, 'f' for farenheit, 'k' for kelvin)")
...
if temp_scale == 'f':
    convert_scale = input("Enter the scale you would like to convert to:")
    if convert_scale == 'c':
      f_convert = (starting_temp - 32 * 2.35)
      print(f_convert)
      if convert_scale == 'k':
        f_convert = (starting_temp - 32 * 2.35 + 273)
        print(f_convert)
        pass
